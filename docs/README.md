...
- **[Motrix配合指南](SEGMENT2MOTRIX_GUIDE.md)** - DASH视频下载与合并指南
- **[性能基准指南](benchmark_guide.md)** - 编码器性能测试与对比

### 🔧 技术文档
- **[网络共享](NETWORK_SHARING.md)** - 网络共享功能使用说明
- **[未来需求](dev/future_requirements.md)** - 优化想法与需求池
...
- **最后更新**: 2026-01-10
- **架构版本**: v3.0.1
- **测试状态**: 批量DASH合并 100% 成功率验证，单文件转码已实测成功
